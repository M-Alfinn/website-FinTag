      ...
      <section className="grid grid-cols-1 md:grid-cols-12 md:grid-rows-6 gap-4 lg:gap-6 min-h-[85vh]">
        ...
        >
          <div className="z-10 space-y-4">
            ...
            <p className="text-slate-500 dark:text-slate-400 font-mono tracking-widest text-[10px]">FINTAG // MANUAL READY // KELOMPOK 3</p>
          </div>
          
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6 z-10 pt-8 sm:pt-0">
            <div className="space-y-4">
              <div className="flex items-center gap-4 text-3xl lg:text-4xl font-heading font-bold text-slate-400 dark:text-slate-500">
                <motion.span
                  key={text}
                  initial={{ scale: 1 }}
