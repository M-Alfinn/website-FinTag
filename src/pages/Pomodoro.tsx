        ...
        >
            ...
            <div className="flex items-center justify-center gap-6 w-full max-w-md">
                <button 
                  ...
                  className="w-14 h-14 rounded-full border border-slate-100 dark:border-white/10 text-slate-400 dark:text-slate-100 hover:text-primary hover:border-primary/20 transition-all bg-white dark:bg-slate-900 shadow-sm flex items-center justify-center group shrink-0"
                >
                ...
                <button 
                    onClick={toggleTimer}
                    className={cn(
                        "flex-1 py-5 rounded-[28px] font-bold text-xl flex items-center justify-center gap-3 shadow-xl transition-all active:scale-95 group",
                        isActive ? "bg-secondary dark:bg-slate-800 text-white" : "bg-primary text-white shadow-primary/20"
                    )}
                >
                    {isActive ? <Pause className="w-6 h-6 fill-current" /> : <Play className="w-6 h-6 fill-current shadow-lg" />}
                    <span className="text-sm uppercase tracking-widest text-white">{isActive ? 'Pause' : 'Start Focus'}</span>
                </button>
                <button 
                    onClick={resetTimer}
                    className="w-14 h-14 rounded-full border border-slate-100 dark:border-white/10 text-slate-400 dark:text-slate-100 hover:text-rose-500 hover:border-rose-100 transition-all bg-white dark:bg-slate-900 shadow-sm flex items-center justify-center shrink-0"
                >
